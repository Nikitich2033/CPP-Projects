...
int main() {
...

    {
        ...
        vector<int> shouldBe{2,6,8};

        if (numbersOut == shouldBe) {
            cout << "2) Pass: making a list for {2,4,6,8} using an initializer list, then erasing 4, gives the list {2,6,8}\n";
        } else {
            ++retval;
            cout << "2) Fail: making a list for {2,4,6,8} using an initializer list, then earsing 4, should give the list {2,6,8} but instead produced the list: {";
...

    {
        ...
        if (numbersOut == shouldBe) {
            cout << "5) Pass: making a const list for {2,4,6,8} using an initializer list, then looping over it, gets these values\n";
        } else {
            ++retval;
            cout << "5) Fail: making a const list for {2,4,6,8} using an initializer list, then looping over it, gets the values: {";
            for (auto n : numbersOut) {
                cout << " " << n;
            }
            cout << " }\n";
...

    {
        ...
        vector<int> shouldBe{3,4,6,8};

        if (numbersOut == shouldBe) {
            cout << "6) Pass: Making a list for {2,4,6,8} using an initializer list, then inserting 3 before 4, then erasing 2, gives the list {3,4,6,8}\n";
        } else {
            ++retval;
            cout << "6) Fail: Making a list for {2,4,6,8} using an initializer list, then inserting 3 before 4, then erasing 2, gives the list {3,4,6,8}, but instead produced the list: {";
